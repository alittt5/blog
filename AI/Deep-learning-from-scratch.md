...
![[AI/pic/2C`5]_W1_@Q})QR[~L8Z7ZJ.png]]
![[AI/pic/%0PZ9YG`%24]J84}QT%RV8R.png]]
### 2.2 感知机的实现
使用使用权重和偏置实现**与门**。
``` python
def AND(x1, x2):  
...
![AI/pic/[I1OPN4D]3H}G}ZU3[B2D$JW.png]]
...
![[AI/pic/MI[D@_RGD[TP()9}Q9(6VYT.png]]
### 3.2 激活函数
...
![[AI/pic/Pasted image 20220920151028.png]]
![[AI/pic/Pasted image 20220920151115.png]]
...
![[AI/pic/C0H4)GZTMVQH4Q_Y4CKD3FQ.png]]
**优点：**
...
$$
![[AI/pic/[WRR))LW3QTU%EZQBY_5A8K.png]]
Tanh函数是 0 均值的，因此实际应用中 Tanh 会比 sigmoid 更好。但是仍然存在梯度饱和与exp计算的问题。
#### 3.2.3 ReLU函数
ReLU函数定义如下：$$
f(x)=\max (0, x)
$$
![[AI/pic/]({8_NFQ_CWH7)6K0F}66X8.png]]
**优点：**
...
### 3.3 神经网络信号传递
![[AI/pic/U8Z$S9YVP@~H$_A7(3%)AZU.png]]
...
隐藏层的层数与神经网络的效果/用途，可以用如下表格概括：![[AI/pic/Pasted image 20220920155108.png]]
